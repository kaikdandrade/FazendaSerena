...
const CACHE_NAME = "fazenda-serena-pwa-r37f-install";
const APP_SHELL = [
  "/",
  "/index.html",
  "/play.html",
  ...
  "/css/release-ui.css?v=r37f",
  "/js/appConfig.js?v=r37f",
  "/js/data.js?v=r37f",
  "/js/gameAdmin.js?v=r37f",
  "/js/engine/GameEngineCore.js?v=r37f",
  "/js/engine/GameEngineOrdersMissions.js?v=r37f",
  "/js/engine/GameEnginePrestigeSettings.js?v=r37f",
  "/js/app/appState.js?v=r37f",
  "/js/app/appUtils.js?v=r37f",
  "/js/app/appAccountSocial.js?v=r37f",
  "/js/app/appCropsStock.js?v=r37f",
  "/js/app/appCommerceMissions.js?v=r37f",
  "/js/app/appStatistics.js?v=r37f",
  "/js/app/appRendererActions.js?v=r37f",
  "/js/app/appEventsLoop.js?v=r37f",
