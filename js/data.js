...
window.GameData = (() => {
  ...
  const prestigeUpgrades = [
    { id: "royalTreasury", name: "Tesouro da dinastia", icon: "👑", desc: "A jornada começa com 2 mil moedas e recebe mais 2 mil moedas por nível.", max: 10, baseCost: 1, growth: 1.72 },
