...
window.GameData = (() => {
  ...
  const upgrades = [
    ...
    { id: "warehouse", name: "Celeiro modular", icon: "🏡", desc: "+70 de capacidade por cultura.", max: 30, baseCost: 300, growth: 1.62, currency: "coins" },
  ...
  const research = [
    ...
    { id: "storageScience", name: "Conservação natural", icon: "🧺", desc: "+45 de capacidade por cultura.", max: 15, baseCost: 3, growth: 1.61 },
  ...
  const prestigeUpgrades = [
    ...
    { id: "storageLegacy", name: "Celeiro ancestral", icon: "🪵", desc: "+50 de capacidade permanente por nível.", max: 15, baseCost: 2, growth: 1.66 }
  ];
  ...
  const missions = [
    ...
    { id: "tier6", title: "Ferramentas cuidadas", desc: "Some 6 níveis de equipamento nas culturas.", metric: "tiers", target: 6, reward: { coins: 850 } },
    { id: "contract3", title: "Parcerias locais", desc: "Complete 3 contratos.", metric: "contracts", target: 3, reward: { research: 5 } },
    { id: "mastery8", title: "Mãos experientes", desc: "Alcance domínio 8 em uma cultura.", metric: "mastery", target: 8, reward: { coins: 1800, research: 3 } },
