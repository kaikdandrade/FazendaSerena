...
window.GameData = (() => {
 // Catálogos de conteúdo administráveis. Desde esta, categorias e
  ...
  const research = [
    ...
    { id: "logisticsSimulation", name: "Simulação logística", icon: "assets/icons/relogio.webp", desc: "+6% de velocidade na conclusão automática dos contratos.", max: 10, baseCost: 14, growth: 1.86 },
  ...
  const prestigeUpgrades = [
    ...
    { id: "sovereignNetwork", name: "Rede soberana", icon: "assets/icons/caminhao-entrega.webp", desc: "20% a mais nas moedas de contratos, +10% de velocidade de conclusão dos contratos e +10% no valor das vendas automáticas por nível.", max: 8, baseCost: 8, growth: 2.25 },
