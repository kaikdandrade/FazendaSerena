...
(() => {
  ...
  function contractMarkup(){
    ...
    if(!state.unlocks.contracts) return `<article class="contract-card contract-card-foundation"><div class="contract-main-preview"><img src="assets/icons/cadeado.webp" alt=""><div><span class="contract-type-label"><i></i>Bloqueado</span><h3>Contratos</h3><div class="contract-main-meta"><span>Alcance o nível 2 para liberar Contratos.</span></div></div></div></article>`;
    if(!c.accepted&&!c.claimed) return `<article class="contract-card contract-card-foundation contract-offer-card" style="--contract-type-color:#7aa668"><header class="contract-card-header-preview"><div class="contract-company-preview"><span><img src="assets/icons/contrato-comercial.webp" alt=""></span><div><small>Parceiro comercial</small><strong>Mercado Escola</strong></div></div><span class="contract-time-preview contract-proposal-time"><small>Proposta</small><span><img src="assets/icons/relogio.webp" alt=""><b>${tutorialContractTime(c.duration)}</b></span></span></header><div class="contract-main-preview"><img src="assets/plants/folha.webp" alt="Folha"><div><span class="contract-type-label"><i></i>Comercial</span><h3>12 <span>Folha</span></h3></div></div><div class="contract-reward-strip"><span class="contract-reward-title">Recompensa</span><strong class="contract-reward-values">${tutorialContractRewardMarkup()}</strong></div><footer class="contract-offer-actions-preview contract-offer-single-action"><button class="button primary" type="button" data-contract-accept>Assinar</button></footer></article>`;
    if(c.claimed) return `<article class="contract-card contract-card-foundation contract-completed-card" style="--contract-type-color:#7aa668"><header class="contract-card-header-preview"><div class="contract-company-preview"><span><img src="assets/icons/contrato-comercial.webp" alt=""></span><div><small>Parceiro comercial</small><strong>Mercado Escola</strong></div></div><span class="contract-time-preview">Concluído</span></header><div class="contract-main-preview"><img src="assets/plants/folha.webp" alt="Folha"><div><span class="contract-type-label"><i></i>Comercial</span><h3>12 <span>Folha</span></h3></div></div><div class="contract-reward-strip"><span class="contract-reward-title">Recompensa recebida</span><strong class="contract-reward-values">${tutorialContractRewardMarkup()}</strong></div></article>`;
    ...
    return `<article class="contract-card contract-card-foundation ${done?"contract-completed-card":""}" style="--contract-type-color:#7aa668"><header class="contract-card-header-preview"><div class="contract-company-preview"><span><img src="assets/icons/contrato-comercial.webp" alt=""></span><div><small>Parceiro comercial</small><strong>Mercado Escola</strong></div></div><span class="contract-time-preview contract-completion-time"><small>Conclusão</small><span><img src="assets/icons/relogio.webp" alt=""><b data-tutorial-contract-time>${timer}</b></span></span></header><div class="contract-main-preview"><img src="assets/plants/folha.webp" alt="Folha"><div><span class="contract-type-label"><i></i>Comercial</span><h3>12 <span>Folha</span></h3><div class="contract-main-meta"><span>Progresso</span><strong data-tutorial-contract-percent>${Math.floor(pct)}%</strong></div></div></div><div class="contract-progress-preview"><div><span>Preenchido</span><strong>${c.delivered} / 12</strong></div><div class="progress-track"><span style="width:${pct}%"></span></div></div><div class="contract-reward-strip"><span class="contract-reward-title">Recompensa</span><strong class="contract-reward-values">${tutorialContractRewardMarkup()}</strong></div>${done?'<footer class="contract-card-footer-preview contract-full-action-footer"><button class="button gold contract-full-action contract-claim-action" type="button" data-contract-claim>Receber recompensa</button></footer>':'<footer class="contract-card-footer-preview"><button class="button secondary" type="button" disabled>Preenchendo automaticamente...</button></footer>'}</article>`;
  }
  ...
  function updateContractLive(){
    ...
    const progress=root.querySelector(".contract-progress-preview");
    if(!progress) return;
